 ...
 */
public class WxPayProcessor extends PayProcessor{
	...
	public PayResp process(PayReq payReq) throws HaBizException {
		...
		String appId = IPayConfig.APP_ID;
		...
		String mhtOrderAmt = String.valueOf((int)(payReq.getAmt() * VRates.RATE));
		...
		String deviceType = IPayConsts.DEVICE_TYPE;
		String payChannelType = IPayConsts.WECHAT_CHANNEL;
		String outputType = IPayConsts.OUT_PUT_TYPE;
		String appKey = IPayConfig.MD5_KEY;
